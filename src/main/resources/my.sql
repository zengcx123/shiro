...
INSERT INTO `ly_resources` VALUES ('35', '重置密码', '2', 'account_reset', '2', '/user/resetPassword.shtml', '22', null, '0', '&lt;button&nbsp;type=&quot;button&quot;&nbsp;id=&quot;reset&quot;&nbsp;class=&quot;btn&nbsp;btn&nbsp;btn-grey&nbsp;marR10&quot;&gt;重置密码&lt;/button&gt;');
...
CREATE TABLE `ly_role` (
  ...
  `state` varchar(3) DEFAULT '1' COMMENT '是否禁用0:禁用1:正常',
  `name` varchar(50) DEFAULT NULL,
