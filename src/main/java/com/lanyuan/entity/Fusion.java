 ...
 */
public class Fusion extends FormMap {
    //材料领用主表
    private int id1;
    private int useId1;
    private String rawId1;
    private String fusionNo1;
    ...
    public int getUseId1() {
        return useId1;
    }

    public void setUseId1(int useId1) {
        this.useId1 = useId1;
    }
    ...
    public String getFusionNo1() {
        return fusionNo1;
    }

    public void setFusionNo1(String fusionNo1) {
        this.fusionNo1 = fusionNo1;
    }
