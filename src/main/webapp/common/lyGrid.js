...
(function() {
	lyGrid = (function(params,callback) {
		...
		//------------------------带参数-----------------------//
		var exportDataWithCondition = function(url,orderNumber,productName,createDate1,createDate2,customerId){
			var form=$("<form>");//定义一个form表单
			form.attr("style","display:none");
			form.attr("target","");
			form.attr("method","post");
			...
			var input1=$("<input>");
			input1.attr("type","hidden");
			input1.attr("name","orderNumber");
			input1.attr("value",orderNumber);
			form.append(input1);
			...
			input3.attr("name","createDate1");
			input3.attr("value",createDate1);
			form.append(input3);

			var input4=$("<input>");
			input4.attr("type","hidden");
			input4.attr("name","createDate2");
			input4.attr("value",createDate2);
			form.append(input4);

			var input5=$("<input>");
			input5.attr("type","hidden");
			input5.attr("name","customerId");
			input5.attr("value",customerId);
			form.append(input5);
		...
		return {
			...
			exportDataWithCondition:exportDataWithCondition,//导出数据
