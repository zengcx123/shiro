        ...
        <div class="navbar-header aside-md">
            <a class="btn btn-link visible-xs"
               data-toggle="class:nav-off-screen,open" data-target="#nav,html">
                ...
                src="${ctx}/notebook/notebook_files/logo.png" class="m-r-sm">横泾阀门</a>
            ...
            <li class="dropdown">
                <a href="index.html#" class="dropdown-toggle" data-toggle="dropdown">
                    <span class="thumb-sm avatar pull-left">
                        <%--<img src="${ctx}/headPicture/1.jpg" style="width: 40px;height: 30px;">--%>
                        <c:if test="${userFormMap.headPic != '' && userFormMap.headPic != null}">
                            <img src="${ctx}/headPic/${userFormMap.headPic}" style="width: 50px;height: 30px;">
                        </c:if>
                        <c:if test="${userFormMap.headPic == '' || userFormMap.headPic == null}">
                            <img src="${ctx}/headPicture/1.png" style="width: 50px;height: 30px;">
                        </c:if>
                    </span>
                    欢迎您，${userFormMap.userName}！
                    <b class="caret"></b>
                </a>
                <ul class="dropdown-menu animated fadeInRight">
                    <span class="arrow top"></span>
                    <%--<li><a href="index.shtml#">Settings</a></li>--%>
                    <li><a href="#" onclick="javascript:uploadHead();">更换头像</a></li>
                                        ...
                                        <li
                                            ...
                                            <a href="javascript:void(0)"
                                               <c:if test="${s.index==0}">class="active"</c:if>>
                                                ...
                                                <c:if test="${s.index==0}">
                                                    <i class="fa fa-th-list icon"><b class="bg-empty"></b></i>
                                                </c:if>
                                                <c:if test="${s.index==1}">
                                                    <i class="fa fa-th-list icon"><b class="bg-empty"></b></i>
                                                </c:if>
