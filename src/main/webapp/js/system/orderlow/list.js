...
$(function() {
	...
	grid = lyGrid({
		...
		jsonUrl : rootPath + '/orderlow/findByPage.shtml',
		//dymCol:true,
		checkbox : true,
		//serNumber : true
	});
...
function searchDetail(id){
	pageii = layer.open({
		...
		type : 2,
		area : [ "900px", "90%" ],
		content : rootPath + '/orderlow/searchDetailUI.shtml?id=' + id
	});
}
...
function addDetail(){
	...
	pageii = layer.open({
		...
		type : 2,
		area : [ "800px", "70%" ],
		content : rootPath + '/orderlow/detail/addUI.shtml?id=' + cbox
	});
}
...
function addFun() {
	pageii = layer.open({
		...
		type : 2,
		area : [ "95%", "95%" ],
		content : rootPath + '/orderlow/addUI.shtml'
	});
}
function editFun() {
	var cbox = grid.getSelectedCheckbox();
	...
	pageii = layer.open({
		...
		type : 2,
		area : [ "95%", "95%" ],
		content : rootPath + '/orderlow/editUI.shtml?id=' + cbox
	});
}
function delFun() {
	var cbox = grid.getSelectedCheckbox();
	...
	layer.confirm('是否删除？', function(index) {
		var url = rootPath + '/orderlow/deleteEntity.shtml';
