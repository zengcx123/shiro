...
$(function() {
	...
	grid = lyGrid({
		...
		jsonUrl : rootPath + '/orderlow/detail/findByPage.shtml',
		checkbox : true
	});
...
function updateStatus(id){
	pageii = layer.open({
		...
		type : 2,
		area : [ "500px", "40%" ],
		content : rootPath + '/orderlow/detail/updateStatusUI.shtml?id=' + id
	});
}
function addDetailStatus(){
	...
	pageii = layer.open({
		...
		type : 2,
		area : [ "800px", "80%" ],
		content : rootPath + '/orderlow/detail/status/addUI.shtml?id=' + cbox
	});
}
...
function editFun() {
	...
	pageii = layer.open({
		...
		type : 2,
		area : [ "800px", "70%" ],
		content : rootPath + '/orderlow/detail/editUI.shtml?id=' + cbox
	});
}
function delFun() {
	var cbox = grid.getSelectedCheckbox();
	...
	layer.confirm('是否删除？', function(index) {
		var url = rootPath + '/orderlow/detail/deleteEntity.shtml';
