...
$(function() {
	...
	grid = lyGrid({
		...
		jsonUrl : rootPath + '/orderlow/detail/status/findByPage.shtml',
		checkbox : true
	});
...
function editFun() {
	...
	pageii = layer.open({
		...
		type : 2,
		area : [ "900px", "95%" ],
		content : rootPath + '/orderlow/detail/status/editUI.shtml?id=' + cbox
	});
}
function delFun() {
	var cbox = grid.getSelectedCheckbox();
	...
	layer.confirm('是否删除？', function(index) {
		var url = rootPath + '/orderlow/detail/status/deleteEntity.shtml';
