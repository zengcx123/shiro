...
<head>
    ...
    <script type="text/javascript" src="${ctx}/js/system/orderlow/edit.js"></script>
    <style type="text/css">
        .col-sm-3 {
            width: 15%;
            float: left;
...
<form id="form" name="form" class="form-horizontal" method="post" action="${ctx}/orderlow/editEntity.shtml">
