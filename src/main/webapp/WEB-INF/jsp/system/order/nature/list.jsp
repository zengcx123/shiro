...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/system/order/nature/list.js"></script>
	<div class="m-b-md">
		<form class="form-inline" role="form" id="searchForm"
			name="searchForm">
			<div class="form-group">
				<label class="control-label"> <span
					class="h4 font-thin v-middle">订单性质:</span></label> <input
					class="input-medium ui-autocomplete-input" id="nature"
					name="orderNatureFormMap.nature">
			</div>
