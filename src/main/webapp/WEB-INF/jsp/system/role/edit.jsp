				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control checkacc"
							placeholder="请输入关键字" name="roleFormMap.roleKey" id="roleKey" value=${role.roleKey}>
					</div>
				</div>
				<div class="line line-dashed line-lg pull-in"></div>
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="btn-group m-r">
							<button data-toggle="dropdown"
								...
								<span class="dropdown-label"><c:if test="${role.state eq 0}">禁用</c:if><c:if test="${role.state eq 1}">正常</c:if></span> <span class="caret"></span>
							</button>
							<ul class="dropdown-menu dropdown-select">
								<li class=""><a href="#"><input type="radio"
										name="roleFormMap.state" value="0"<c:if test="${role.state eq 0}"> checked="checked"</c:if>>禁用</a></li>
								<li class="active"><a href="#"><input type="radio"
										name="roleFormMap.state" value="1" <c:if test="${role.state eq 1}"> checked="checked"</c:if>>正常</a></li>
							</ul>
						</div>
					</div>
				</div>
