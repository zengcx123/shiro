...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/system/produce/list.js"></script>
	<div class="m-b-md">
		<form class="form-inline" role="form" id="searchForm"
			...
			<div class="form-group">
				<label class="control-label"> <span
					...
					name="produce.productPicNo">
			</div>
			<div class="form-group">
				<label class="control-label"> <span
						class="h4 font-thin v-middle">需交日期:</span></label>
				<input class="Wdate" id="needDate"
					   name="produce.needDate" onClick="WdatePicker()">
			</div>
			<div class="form-group">
				<label class="control-label"> <span
						class="h4 font-thin v-middle">是否完成:</span></label>
				<select id="isFinish" name="produce.isFinish" style="width: 155px;height: 27.5px;">
