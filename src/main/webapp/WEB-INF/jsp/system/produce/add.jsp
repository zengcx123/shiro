...
<head>
    ...
    <script type="text/javascript" src="${ctx}/js/system/produce/add.js"></script>
...
<form id="form" name="form" class="form-horizontal" method="post"
      action="${ctx}/produce/addEntity.shtml">
    <section class="panel panel-default">
        <div class="panel-body">
            <div class="form-group">
                <label class="col-sm-3 control-label">委铸单位</label>
                <div class="col-sm-9">
                    <select id="customerId" name="customerId" style="width: 155px;height: 27.5px;">
