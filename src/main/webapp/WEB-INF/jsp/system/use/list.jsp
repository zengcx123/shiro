...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/system/use/list.js"></script>
	<div class="m-b-md">
		<form class="form-inline" role="form" id="searchForm"
			name="searchForm">
			<div class="form-group">
				<label class="control-label"> <span
						class="h4 font-thin v-middle">领用日期:</span></label>
				<input class="Wdate" id="createDate1"
					   name="use.createDate1" onClick="WdatePicker()">
			</div>
