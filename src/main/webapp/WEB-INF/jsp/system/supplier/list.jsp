		...
		<form class="form-inline" role="form" id="searchForm"
			...
			<div class="form-group">
				<label class="control-label"> <span
					...
					class="input-medium ui-autocomplete-input" id="company"
					name="supplierFormMap.company">
			</div>
			<div class="form-group">
				<label class="control-label"> <span
						class="h4 font-thin v-middle">联系人:</span></label> <input
					class="input-medium ui-autocomplete-input" id="name"
					name="supplierFormMap.name">
			</div>
			<div class="form-group">
				<label class="control-label"> <span
						class="h4 font-thin v-middle">联系方式:</span></label> <input
					class="input-medium ui-autocomplete-input" id="telephone"
					name="supplierFormMap.telephone">
			</div>
